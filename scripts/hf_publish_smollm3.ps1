# Publish SmolLM3-3B (re-converted 2026-09-18, native smollm3 export, 17/26 on 2026.4) — 2026-09-20.
...
#
#   pwsh -File scripts\hf_publish_smollm3.ps1
#
...
$jobs = @(
  @{ id = 'HarmenWessels/SmolLM3-3B-int4-symg128-ov'
     msg = 'SmolLM3-3B int4 sym g128 AWQ+SE, native smollm3 export, tokenizer IR rebuilt with the id-0 / regex fixes' }
)
...
Write-Host "`ndone. Next: flip 'published: true' in the SmolLM3 card, re-assemble, add it to the GPU collection." -ForegroundColor Green
